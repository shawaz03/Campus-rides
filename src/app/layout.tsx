...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "bike sharing for college students",
    "student bike transport app",
    "campus bike pool",
    "college transport app for students",
    "student bike taxi",
    "two-wheeler ride share for college",
    "college campus travel app",
