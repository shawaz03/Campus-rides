...
export const CarMascot = ({ className = "" }) => (
...
export const CloudDoodle = ({ className = "" }) => (
...
export const StarDoodle = ({ className = "", color = "#FF5A36" }) => (
...
export const BlobDoodle = ({ className = "", color = "#9B5DE5" }) => (
...
export const SquiggleDoodle = ({ className = "", color = "#1B1B1F" }) => (
...
export const ArrowDoodle = ({ className = "", color = "#1B1B1F" }) => (
...
export const PinDoodle = ({ className = "" }) => (
...
export const CoinDoodle = ({ className = "" }) => (
...
export const SkateDoodle = ({ className = "" }) => (
...
export const ChatDoodle = ({ className = "" }) => (
...
export const PaperPlane = ({ className = "" }) => (
  <svg viewBox="0 0 120 100" className={className} fill="none">
...
export const FriendMascot = ({ className = "", hat = "#FF5A36" }) => (
...
export const RoadPath = ({ className = "" }) => (
